...
type DefaultCommandServiceProvider struct {
}

func (r *DefaultCommandServiceProvider) Relationship() binding.Relationship {
...
func (r *DefaultCommandServiceProvider) Register(app foundation.Application) {
}

func (r *DefaultCommandServiceProvider) Boot(app foundation.Application) {
	r.registerCommands(app)
}

func (r *DefaultCommandServiceProvider) registerCommands(app foundation.Application) {
