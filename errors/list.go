...
var (
	...
	OrmMorphRelationNotConfigured   = New("polymorphic relation %q must be declared via the MorphRelations() method on model %s")
	OrmMorphRelationKindUnknown     = New("polymorphic relation %q on model %s has unknown kind %q")
